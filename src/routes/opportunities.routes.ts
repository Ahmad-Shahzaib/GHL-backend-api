...
router.get(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    const opportunitiesResponse = await ghlClient.getOpportunities({
      limit,
      page,
      pipelineId,
      stageId,
...
router.get(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    if (!id) {
      throw Errors.BadRequest('Opportunity ID is required');
    }
...
/**
 * @route   GET /api/opportunities/pipeline/:pipelineId
 * @desc    Get opportunities by pipeline ID
 * @access  Private
 */
router.get(
  '/pipeline/:pipelineId',
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    if (!pipelineId) {
      throw Errors.BadRequest('Pipeline ID is required');
    }
...
/**
 * @route   GET /api/opportunities/stage/:stageId
 * @desc    Get opportunities by stage ID
 * @access  Private
 */
router.get(
  '/stage/:stageId',
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    if (!stageId) {
      throw Errors.BadRequest('Stage ID is required');
    }
